...
<body>
    ...
    <div id="wrapper">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="user-pro">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="settings.php"><i class="ti-settings"></i> Cái đặt tài khoản</a></li>
                   ...
                   <li><a href="inbox.php" class="waves-effect"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Tin nhăn</span></a>
                    </li>
                    ...
                    <li><a href="subscribers.php" class="waves-effect"><i data-icon="n" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Người theo dõi</span></a>
                     ...
                     <li class="nav-small-cap">--- Cái đặt khác</li>
                    <li> <a href="#" class="waves-effect"><i data-icon="H" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Quyền truy cập<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
        ...
        <div id="page-wrapper">
                                    ...
                                    <div class="inbox-center">
                                            <?php  
                                                            if (isset($_GET['posted'])) {
                                                                echo'<div class="alert alert-success" >
                                                                   ...
                                                                   <strong>DONE!! </strong><p> Bài đăng mới của bạn đã được tải lên.</p>
                                                                   </div>';
                                                            }    
                                                            ...
                                                            '<div class="alert alert-warning" >
                                                                 ...
                                                                 <strong>DELETED!! </strong><p> Bài đăng của bạn đã được xóa</p>
                                                            </div>'
                                                            ;
                                                        }
                                                        elseif (isset($_GET["del_error"])) {
                                                            ...
                                                            '<div class="alert alert-danger" >
                                                                  <a href="#" class="close" data-dismiss="alert" aria-label="close"></a>
                                                                 <strong>ERROR!! </strong><p> Đã gặp vấn đề. Xin vui lòng thử lại.</p>
                                                            </div>'
                                                            ;
                                                        }                                                        
                                                        ?>
                                        <table class="table table-hover">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <h4>Bài đăng gần đây (<b style="color: orange;"><?php echo mysqli_num_rows($query);?></b>)</h4>
                                                        <?php 
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2024 &copy; Bài đăng </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
