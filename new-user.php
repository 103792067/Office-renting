                                    ...
                                    <form action="new-tenant.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="tname" class="form-control" id="hname" placeholder="Hãy điền tên người dùng" required=""> </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="temail" class="form-control" id="temail" placeholder="example@gmail.com"> </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="idnum">Số ID: *</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                                <input type="number" min="1000" required name="idnum" class="form-control" id="idnum" placeholder="01" > </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="house">Phòng thuê: *</label>
                                            <div class="input-group">
                                        ...
                                        <button type="submit" name="admitTenant" class="btn btn-success btn-lg waves-effect waves-light m-r-10 center"><i class="fa fa-plus-circle fa-lg"></i> Tạo người dùng</button>
                                    </form>
                                </div>
                            </div>
                        </div>
